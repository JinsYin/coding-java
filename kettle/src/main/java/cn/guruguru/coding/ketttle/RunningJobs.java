 ...
 *
 * <p><a href="https://github.com/pentaho/pdi-sdk-plugins/blob/master/kettle-sdk-embedding-samples/src/main/java/org/pentaho/di/sdk/samples/embedding/RunningJobs.java">cn.guruguru.coding.ketttle.RunningJobs.java</a>
 */
public class RunningJobs {
    ...
    public static void main( String[] args ) {
        ...
        Job job = instance.runJobFromFileSystem( "kettle/src/main/resources/job1.kjb" );
    ...
    public Job runJobFromFileSystem( String filename ) {
        ...
        try {
            ...
            // The next section reports 111on the declared parameters and sets them
            // to arbitrary values
